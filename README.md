...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flake8-functions-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14458&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flake8-functions-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flake8-functions` can be installed with:

```
conda install flake8-functions
```

It is possible to list all of the versions of `flake8-functions` available on your platform with:
